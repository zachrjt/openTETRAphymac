...
def calculate_phase_adjustment_bits(input_data: NDArray[uint8],
    ...
    dphi = DQPSK_PHASE_TRANSITION_LUT[coded_transistions] # if you get an out of range here, then your indices are off,
                                                          # reading random (0-255) values in unset phase adjustment bits
